const owners = [
    { id: 10, title: 'ap. 1', ownerName: 'Вили и Иван' },
    { id: 20, title: 'ap. 2', ownerName: 'Денис' },
    { id: 30, title: 'ap. 3', ownerName: 'Силвия' },
    { id: 40, title: 'ap. 4', ownerName: 'Цанко' },
    { id: 50, title: 'ap. 5', ownerName: 'СТеф' },
...
const flats = [
    { id: 1, name: 'ap. 1', owner: 10, active: true },
    { id: 2, name: 'ap. 2', owner: 20, active: true },
    { id: 3, name: 'ap. 3', owner: 30, active: false },
    { id: 4, name: 'ap. 4', owner: 40, active: true },
    { id: 5, name: 'ap. 5', owner: 50, active: true },
